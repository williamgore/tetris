...
void draw() {
  if (!testEndGame()) {
    ...
    //in purple
    drawCells(landedX, landedY, landedSize, #B026FF);
 ...
 */
void drawCells(int[] x, int[] y, int size, int colour) {
...
*/
void generatePiece(int[] x, int[] y, int startRow) {
